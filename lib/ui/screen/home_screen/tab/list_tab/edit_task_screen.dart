...
import 'package:todo/ui/utilities/app_color.dart';
...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  late TaskDm taskModal ;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
       taskModal = ModalRoute.of(context)!.settings.arguments as TaskDm;
  ...
  void editTaskToFireStore() {
    if (formKey.currentState?.validate() == true) {
      ...
      FirebaseUtils.editTask(uId: authUserProvider.currentUser!.id!, task: taskModal)
          .then((onValue) {
        listProvider
